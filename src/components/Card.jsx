  ...
  return (
    <Link to={`/products/${_id}`} className='card shadow-2xl'>
      ...
      <div className='card-body grid'>
        <div className='grid [grid-template-columns: 1fr auto] items-center text-secondary'>
        ...
        <div className='card-actions justify-end self-end'>
          <button
            type='button'
            className='btn btn-secondary btn-outline btn-sm uppercase text-xs font-bold'
          >
            add to cart
          </button>
        </div>
